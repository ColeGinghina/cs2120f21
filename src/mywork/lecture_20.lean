...
The set of all pairs that satisfy the 
predicate is the relation.

A relation is a subset of a product

A relation is an element of the power set of a product set
