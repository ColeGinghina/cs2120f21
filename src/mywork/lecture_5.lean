...
/-
Prove that if arbitrary propositions P and Q are true
(which is to say that we have a proof of each of them),
that the proposition P and Q is also true

Proof: The conjecture that P and Q is true is proved by application
